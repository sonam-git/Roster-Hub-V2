    ...
    <main className="container lg:mt-20 flex items-center justify-center px-2">
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl">
        ...
        <div
          ...
          `}
        >
          <div className="mt-8 bg-gradient-to-r from-green-400 via-blue-400 to-green-600 dark:from-green-900 dark:via-blue-900 dark:to-green-800 rounded-xl shadow-lg p-6 flex flex-col items-center w-full overflow-x-auto mb-6">
            ...
            <p className="text-white/90 mb-4 text-center w-full break-words">
              Sign up to connect with your team, track games, and share your
              soccer journey.
            </p>
            <ul className="text-white/90 mb-4 text-left w-full max-w-lg list-disc list-inside space-y-2">
              <li>
                ...
                with photos, jersey numbers, positions, and more
              </li>
              <li>
                Endorse teammates’{" "}
                <span className="font-semibold text-yellow-200">skills</span>{" "}
                and give{" "}
                <span className="font-semibold text-yellow-200">
                  star ratings
                </span>
              ...
              <li>
                Real-time{" "}
                <span className="font-semibold text-yellow-200">
                  chat, messaging, likes, and comments
                </span>
              </li>
              <li>
                Coaches/admins can create{" "}
                <span className="font-semibold text-yellow-200">
                  game polls
                </span>{" "}
              ...
              <li>
                ...
                with live match schedules and scores
              </li>
            </ul>
            <a
              href="/signup"
