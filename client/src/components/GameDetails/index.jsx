...
const GameDetails = ({ gameId }) => {
  ...
  const handleVote = isAvailable => {
    respondToGame({ variables: { input: { gameId, isAvailable } } });
  };
    ...
    <div className={`max-w-4xl mx-auto p-6 rounded-lg shadow-md grid grid-cols-1 lg:grid-cols-2 gap-8 ${
      ...
      <div>
        ...
        {isCreator ? (
          <div className="mb-4">
            ...
            <textarea
              ...
              className={`w-full px-3 py-2 border rounded ${
                isDarkMode ? "dark:bg-gray-700 dark:text-gray-200 border-gray-600"
          ...
          <p className="mb-4"><span className="font-bold">Note:</span> {game.notes || "No notes provided"}</p>
        )}
        ...
        {game.status !== "PENDING" && (
          <p className="mb-4">
            ...
            <span className={game.status==="CONFIRMED"?"text-green-600":"text-red-600"}>
              {game.status}
            </span>
          </p>
        )}
