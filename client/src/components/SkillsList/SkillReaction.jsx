		...
		<div className="relative flex flex-col items-center" >
			...
			{showEmojiModal && (
				<div className="fixed inset-0 z-[9999] flex items-center justify-center">
					<div
						className="absolute inset-0 bg-gradient-to-br from-blue-200 via-yellow-100 to-red-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 opacity-70 backdrop-blur-sm"
						onClick={closeEmojiModal}
					/>
					<div className="relative flex flex-col items-center justify-center bg-dark-100 dark:bg-gray-900 p-4 rounded-3xl shadow-2xl border-4 border-blue-300 dark:border-blue-800 max-w-md w-full animate-fade-in mx-4">
						...
						<div className="flex flex-wrap gap-3 justify-center mb-4">
							{EMOJIS.map(({ emoji, label }) => (
								<button
									key={label}
									className="text-2xl p-2 rounded-full bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-700 text-blue-900 dark:text-blue-200 shadow"
