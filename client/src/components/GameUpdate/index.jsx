...
const GameUpdate = ({
  ...
  return (
    <div className={`w-full max-w-2xl mx-auto rounded-2xl shadow-2xl border transition-all duration-300 transform scale-100 my-6 sm:my-10 ${
      isDarkMode 
      ...
      <div className={`flex-shrink-0 p-4 sm:p-6 pb-2 sm:pb-4 border-b ${isDarkMode ? "border-gray-700/50" : "border-gray-200/50"}`}>
      ...
      <div className="flex-1 px-2 sm:px-0">
        ...
        <form onSubmit={handleSubmit} className="p-3 sm:p-6">
          ...
          <div className={`flex-shrink-0 pt-4 border-t mt-6 ${isDarkMode ? "border-gray-700/50" : "border-gray-200/50"}`}>
