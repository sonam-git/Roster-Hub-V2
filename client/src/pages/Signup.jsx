      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl">
        ...
        <div className="md:w-1/2 flex flex-col items-center">
          <div className="bg-gray-200 shadow-xl rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-800 w-full max-w-md">
            <h4 className="text-center text-2xl font-bold text-gray-900 dark:text-white mb-6">Sign Up</h4>
            {data ? (
              ...
              <form onSubmit={handleFormSubmit} className="space-y-6">
                ...
                <div className="flex justify-between mt-3 text-sm">
                  <Link to="/login" className="text-gray-600 hover:text-blue-500 dark:text-white dark:hover:text-blue-400">
