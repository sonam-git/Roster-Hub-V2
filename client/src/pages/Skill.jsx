        ...
        <div>
          ...
          `}>
            ...
            <p className="text-center text-base font-medium mb-2">
              {profileId ? `${profile.name}'s` : "You & Your"} friends have endorsed <span className="font-bold text-blue-500">{profile.skills?.length || 0}</span> skill{profile.skills?.length === 1 ? "" : "s"}
            </p>
          </div>
